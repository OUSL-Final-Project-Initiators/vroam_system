...
<head>
    ...
    <title>{{ $dbCategory }} Rentals — VROAM</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        body { font-family: 'Poppins', sans-serif; color: var(--text-dark); background: var(--light-bg); }
        ...
        .nav-link {
            font-weight: 600; color: #333 !important; text-transform: uppercase;
            font-size: 0.78rem; letter-spacing: 0.5px; padding: 8px 12px !important; transition: color 0.2s;
        }
        ...
        .btn-book:disabled, .btn-book.disabled-btn {
            background: #ccc;
            cursor: not-allowed;
        }
        ...
        /* ── Footer ── */
        footer { background: #111827; color: #9ca3af; padding: 28px 0; text-align: center; }
        footer .brand-text { font-size: 1.3rem; font-weight: 800; color: var(--primary-green); }
        footer p { font-size: 0.78rem; margin: 6px 0 0; }
        ...
        .vehicle-card { animation: fadeUp 0.4s ease both; }
    </style>
</head>
<body>
...
<nav class="navbar navbar-expand-lg sticky-top bg-white shadow-sm">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center gap-2" href="{{ route('user.index') }}">
            <img src="{{ asset('assests/images/Logo1.png') }}" alt="VROAM" style="width:44px;height:44px;object-fit:contain;"
...
@php
    ...
    // Vehicles added within the last 3 days are "NEW"
...
<section class="category-hero">
    <div class="container">
        ...
        <p>Browse the latest {{ strtolower($dbCategory) }} listings — newest additions shown first.</p>
    </div>
</section>
    ...
    <div class="container">
        <div class="d-flex align-items-center gap-3 flex-wrap">
            ...
            <div class="d-flex gap-2 flex-wrap ms-auto">
                ...
                <!-- Sort by location (JS driven, simple alphabetical toggle) -->
    ...
    <div class="container">
        @if($vehicles->isEmpty())
            <div class="empty-state">
                ...
                <a href="{{ route('user.index') }}" class="btn mt-3" style="background:var(--primary-green); color:white; border-radius:25px; padding:10px 28px; font-weight:700;">
            ...
            <div class="row g-4" id="vehicleGrid">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 vehicle-col"
                    ...
                    <div class="vehicle-card h-100">
                        ...
                        {{-- NEW badge: shown for the 3 most recently added vehicles --}}
                        @if($index < 3)
                            <span class="badge-new">✦ New</span>
                        @endif

                        <!-- Icon Area -->
                        <div class="card-icon-wrap" style="background: {{ $vehicle->status === 'available' ? '#f0faf4' : ($vehicle->status === 'rented' ? '#fff8f0' : '#fdf0f0') }};">
                            <div class="bg-circle">
                                <i class="fa-solid {{ $heroIcon }}"></i>
                            </div>
                        </div>
...
<div class="container pb-5 text-center">
    <a href="{{ route('user.index') }}" class="btn" style="background:white; border:2px solid var(--primary-green); color:var(--primary-green); border-radius:25px; padding:10px 28px; font-weight:700; font-size:0.85rem; transition:0.2s;"
...
<footer>
    <div class="container">
        <div class="brand-text">VROAM</div>
        <p>© {{ date('Y') }} VROAM Platform. All Rights Reserved.</p>
    </div>
</footer>
...
<script>
    ...
    function sortCards(order) {
        ...
        if (order === 'newest') {
            // restore original DOM order (by data-index)
